    ...
    public class ImageController : Controller
    {
        ...
        private async Task EmbedReport()
        {
            using (var client = new PowerBIClient(new Uri(_appConfig.Authorization.PowerBIApiUrl), new TokenCredentials(powerBIViewModel.AccessToken, "Bearer")))
            {
                ...
                string groupId = groups.Value.FirstOrDefault()?.Id;
                ...
                Report report = reports.Value.Where(r => r.Name == "images").FirstOrDefault();

                if (report != null)
                {
                    powerBIViewModel.EmbedUrl = "https://app.powerbi.com/reportEmbed?reportId=ed4933f7-ec59-4227-8377-dc75c3e7401c&autoAuth=true&ctid=68bcc9b2-d056-4374-a62d-0ad3b5296583&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly93YWJpLXNvdXRoLWVhc3QtYXNpYS1iLXByaW1hcnktcmVkaXJlY3QuYW5hbHlzaXMud2luZG93cy5uZXQvIn0%3D";
        ...
        private void GetAuthorizationCode()
        {
            var queryParams = new NameValueCollection
            {
                ...
                { "redirect_uri", _appConfig.Authorization.RedirectUrl + "/Image"}
            };
